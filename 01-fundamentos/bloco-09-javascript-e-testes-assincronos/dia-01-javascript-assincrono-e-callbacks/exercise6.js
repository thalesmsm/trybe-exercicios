...
// a função recebe duas callbacks que seram executadas se atender a condição de 60% de possibilidade de sucesso ou não, respectiviamente
const sendMarsTemperature = ((onSuccess, onError) => {
  const notBusy = Math.random() <= 0.6
  setTimeout(() => {
    if (notBusy) {
