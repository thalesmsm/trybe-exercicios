...
function changeText(event) {
  const mudar = document.querySelector(".tech");
  mudar.innerText = event.target.value;
}

// 4. Crie uma função que, ao clicar duas vezes em 'Meu top 3 do Spotrybefy', ele
// redirecione para alguma página;
// 4.1. Que tal redirecionar para seu portfólio?
myWebpage.addEventListener("dblclick", goToPage)
function goToPage() {
...
myWebpage.addEventListener("mouseout", reChangeColor);
